...
static public class MathU
{
    ...
    [MethodImpl(INLINED)]
    static public int Round(this float f) => Mathf.RoundToInt(f);
    [MethodImpl(INLINED)]
   ...
   => Mathf.Approximately(v1.x, v2.x) && Mathf.Approximately(v1.y, v2.y);
	...
	[MethodImpl(INLINED)]
	public static Vector3 XZToXYZInt(this Vector2 v2, int y) => new Vector3Int( Mathf.RoundToInt(v2.x), y,  Mathf.RoundToInt(v2.y));
    [MethodImpl(INLINED)]
